...
unique(catch3$Year) # not all LME/eez etc have data for all years
head(catch3)
...
# check EEZ 
# STILL NEED TO CHECK - make sure that EEZ in this file are ok compared to EEZ in effort and catch file - they are less in catch files and you need to check whether this si an issue or not
...
## NOTE - this last version has now be named _revised to send to Villy for checking. Same for catch. it has also been uploaded to DKRZ and named "effort_histsoc_1841_2010.csv" - i.e. without "revised". Same for catch. 
