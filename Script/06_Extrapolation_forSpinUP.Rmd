...
library(patchwork)
pdf("Output/LMEeffortFAOreport.pdf", height = 5, width = 9)
plot_SBZ+plot_CC+plot_annotation(tag_levels = 'A')
dev.off()

jpeg("Output/LMEeffortFAOreport.jpg", width = 10, height = 5, units = 'in', res = 300, bg = "transparent")
plot_SBZ+plot_CC+plot_annotation(tag_levels = 'A')
dev.off()
...
# if FAO PLOT
jpeg("Output/EEZeffortFAOreport.jpg", res = 300, units = "in", height = 9, width = 7) # height = 8, width = 6)
plot1/plot2/plot3
dev.off() 
