...
source("Helper_functions_fishingEffort.R")
...
effort<-effort %>% 
  mutate(LME_FAO = ifelse(LME == 0, paste0("FAO_", fao_area), paste0("LME_", LME)))

# new toKeep
toKeep<-sort(unique(effort2$LME_FAO))
...
if(df_kappa ==6){ # better capture trends 
  ...
  ## WARNING need to readjust according to LME name instead of seq number 
