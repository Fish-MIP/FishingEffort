...
###### WARNING for FAO regions replacing LME 0 - see plot of reconstructed effort printed at end of chunk. Also check that LME trends are the same as before. 
# FAO 81,87,88 # should I adjust? 
...
for(i in 1:length(toKeep)){
  ...
  #### WARNING if the final option is the old version (with partial removal) of war years you need to either go back to the original code inside the function or to change arguments in function below. OK changed argument below 
