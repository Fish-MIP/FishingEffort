...
if(df_kappa == 6){
  name = "Output/reconstructed_effort_for_spinup_totLME2_JeromeComments_kappa6_1841_fixedValues_kappaLME31_EEZ_addFAO_warBugCorrected.pdf" # this version uses EEZ instead of administrative country # this version uses FAO regions instead of LME 0
}else if (df_kappa == 3){
  name = "Output/reconstructed_effort_for_spinup_totLME2_JeromeComments_kappa3_1841_fixedValues_kappaLME31_EEZ_addFAO_warBugCorrected.pdf"
}
