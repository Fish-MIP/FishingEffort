...
# CN only need Cells_LatLon_model_regions.rds and treat as if it was Cells_LatLon_FAO_regions.rds (same format...)
...
join_effort_data <- function(this_file_name){
  ...
  # if(file.exists(this_destination_path)){ # WARNING - CN why this?? files do not exist here. 
    ...
    #   unique() 
    # # 9.75 98.25 # these are mostly coastal. is this Decimal degrees or degrees, minutes and seconds or degrees and decimal minutes? 
    # 
    # # See if points in regional model are are actually in this area
