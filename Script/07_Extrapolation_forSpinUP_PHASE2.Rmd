...
for(i in 1:length(decision)){
  ...
  # i = 17 
  # WARNING problems with FAO_for_LME0_88
...
### WARNING - here define EEZ 0 ??? this is to facilitate data exploration. 
### ARRIVATA QUI 
...
a<-read_csv("/rd/gem/private/users/yannickr/DKRZ_EffortFiles/effort_histsoc_1841_2010_EEZ_addFAO.csv")
