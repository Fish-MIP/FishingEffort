...
date: "July 2022 (Updated Dec 2024)"
output: 
  html_document:
    toc: yes
    toc_float: yes
...
new_dir <- file.path("/home/ubuntu/gem/private/users/gclawson")
```
...
effort <- fread(file.path(new_dir, "effort_histsoc_1950_2017_EEZ_addFAO.csv"), data.table = FALSE)
head(effort)
...
effort <- effort %>% 
  mutate(LME_FAO = ifelse(LME == "", paste0("LME0_FAO", fao_area), paste0("LME_", LME)))

# load reconstructed effort data (temp_data) printed in 07_PHASE1 
load(here("Data/temp_effort.RData")) # the difference with effort above is the 1842-1950 reconstruction
...
# show North sea 
plot_reconstructed_effort_ref[[44]]
...
# pdf("Output/rerun/reconstructed_effort_for_spinup_JeromeComments_1841_fixedValues_kappaLME31_EEZ_addFAO.pdf", height = 8, width = 6)
...
# pdf("Output/rerun/reconstructed_effort_for_spinup_JeromeComments_discards.pdf", height = 8, width = 6)
# marrangeGrob(grobs = plot_reconstructed_effort_ref, nrow=2, ncol=1)
# dev.off()
...
save(reconstructed_effort_ref_all, file = "/home/ubuntu/gem/private/users/gclawson/FishingEffort_Data/temp_effort_EEZ_addFAO.RData")
...
fwrite(x = reconstructed_effort_ref_all, file.path(new_dir, "effort_histsoc_1841_2017_EEZ_addFAO.csv")) 
