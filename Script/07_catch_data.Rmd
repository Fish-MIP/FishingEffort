...
final_effort<- effort # WARNING - no need to save this as it's just the effort you have but here used to check columns
...
save(final_effort, final_catch, file = "/rd/gem/private/users/yannickr/temp_data_from_FishingEffort_Rpj_07script_update.RData")
